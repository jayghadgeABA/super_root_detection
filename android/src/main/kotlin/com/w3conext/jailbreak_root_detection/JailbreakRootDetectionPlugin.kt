package com.w3conext.super_user_detection
...
import com.w3conext.super_user_detection.frida.AntiFridaChecker
import com.w3conext.super_user_detection.magisk.MagiskChecker
...
class JailbreakRootDetectionPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "super_user_detection")
